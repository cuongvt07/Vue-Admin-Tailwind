<template>
    <section class="flex flex-col md:flex-row h-screen items-center">
        <div class="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
            <img src="https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80" alt="" class="w-full h-full object-cover">
        </div>
            ...
            <div class="w-full h-100">
                ...
                <form @submit.prevent="handleSubmit" class="mt-6">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="password" v-model="password" placeholder="Enter Password" minlength="6" 
