            ...
            <div class="flex flex-col justify-between h-full space-y-[10px]">
                <div class="flex flex-col justify-between space-y-[10px]">
                    ...
                    <router-link to="/profile"
                        ...
                        <span v-if="showSide">Profile</span>
                    </router-link>
                    <router-link to="/message"
                        ...
                        <span v-if="showSide">Messages</span>
                    </router-link>
                    <router-link to="/download"
                        ...
                        <span v-if="showSide">Download</span>
                    </router-link>
                </div>
                <div class="h-[50px]">
                    <div>
                        <router-link to="/setting"
                            ...
                            <span v-if="showSide">Setting</span>
                        </router-link>
                    </div>
                </div>
            </div>
